...
def main():
    ...
    try:
        ...
        while True:
            ...
            status = multi(US1_TRIGGER, US1_ECHO, US2_TRIGGER, US2_ECHO, US3_TRIGGER, US3_ECHO, US4_TRIGGER, US4_ECHO, US5_TRIGGER, US5_ECHO, US6_TRIGGER, US6_ECHO)
            print("Lane data taking completed!")
            print("Status: ", status)
            #calling state comaparision function
            (previousLED, counterL1, counterL2, counterL3) = stateComparision(status, previousLED, L1_LED_RED, L1_LED_YELLOW, L1_LED_GREEN, L2_LED_RED, L2_LED_YELLOW, L2_LED_GREEN, L3_LED_RED, L3_LED_YELLOW, L3_LED_GREEN, counterL1, counterL2, counterL3)
