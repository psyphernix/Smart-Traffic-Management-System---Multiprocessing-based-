...
def stateComparision(stateAll, previousLED, r1, y1, g1, r2, y2, g2, r3, y3, g3, counterL1, counterL2, counterL3):
    '''
    ...
    state = [i for i in stateAll[0:6]] # slicing state of ultrasonic sensor
    stateCam = stateAll[6] # state of camera
